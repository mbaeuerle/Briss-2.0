...
public class SingleCluster implements Comparable<SingleCluster> {
    ...
    public ClusterImageData getImageData() {
        if (imageData == null) imageData = new ClusterImageData(pageWidth, pageHeight, pagesToMerge.size());
        return imageData;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (evenPage != other.evenPage) return false;
        if (excludedPageNumber != other.excludedPageNumber) return false;
        if (getRoundedPageHeight() != other.getRoundedPageHeight()) return false;
